...
def gradeP1():
    score = 4
    result = hw2.sudokuCSPToGrid(
        hw2.sudokuCSP([(0, 0, 4), (0, 1, 3), (1, 0, 1), (1, 2, 3), (2, 2, 2), (3, 0, 2), (3, 1, 1)], 2), 2)
    ...
    print "#######################################"
    print "P1 SCORE: " + str(score + bonus) + " / 4 "
    print "#######################################"
...
def gradeP3():
    ...
    for i in range(10):
        bad_run = False
        result = np.reshape(
            hw2.annealSudoku([(0, 0, 4), (0, 1, 3), (1, 0, 1), (1, 2, 3), (2, 2, 2), (3, 0, 2), (3, 1, 1)], 2)[0], 16)
        print "\n"
        answer = [4, 3, 1, 2, 1, 2, 3, 4, 3, 4, 2, 1, 2, 1, 4, 3]
        for i in range(16):
...
def gradeP5():
    ...
    result = hw2.sudokuIPToGrid(
        hw2.sudokuIP([(0, 0, 4), (0, 1, 3), (1, 0, 1), (1, 2, 3), (2, 2, 2), (3, 0, 2), (3, 1, 1)], 2), 2)
    result = np.reshape(result, 16)
    answer = [4, 3, 1, 2, 1, 2, 3, 4, 3, 4, 2, 1, 2, 1, 4, 3]
    for i in range(16):
        if result[i] != answer[i]:
    ...
    print "#######################################"
    print "P5 SCORE: " + str(score + bonus) + " / 4 "
    print "#######################################"
